    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-sm sm:rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('admin.analytics.quizzes') }}" class="w-full text-left bg-indigo-50 border-2 border-indigo-300 shadow-sm sm:rounded-lg hover:shadow-md transition p-6 cursor-pointer focus:outline-none block ring-2 ring-indigo-200">
            ...
            <div data-fragment="quizzes" class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white shadow-sm sm:rounded-lg p-6 border border-gray-200">
                        ...
                        @php
                            $quizUser = $quizUserData[$quiz->id] ?? null;
                            $userNames = $quizUser['userNames'] ?? collect();
                            $attemptCounts = $quizUser['attemptCounts'] ?? collect();
                            $attemptAverages = $quizUser['attemptAverages'] ?? collect();
                        @endphp
