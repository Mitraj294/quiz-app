            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('quizzes.questions.store', $quiz->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="question_text" id="question_text" rows="3" class="w-full  mx-auto rounded-md border-gray-300 bg-white px-3 py-2 shadow-sm placeholder-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
                    </div>
                    ...
                    <div id="media-section" class="mb-4 hidden">
                        <h4 class="block text-sm font-medium mb-2">Add Media To Question</h4>
                    ...
                    <div id="mcq-options" class="mb-4">
                        ...
                        <div class="mt-2">
                            <button type="button" onclick="addOptionField()" class="ml-2 text-red-500 hover:text-red-700 remove-option">+ Add option</button>
                        </div>
                    ...
                    <div id="text-answer" class="mb-4" style="display:none;">
                        ...
                        <input type="text" name="text_answer" id="text_answer_input" class="w-full  mx-auto rounded-md border-gray-300 bg-white px-3 py-2 shadow-sm placeholder-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    </div>

                    <div class="mb-4 grid grid-cols-3 gap-3">
                        <div>
                            <label for="marks" class="block text-sm font-medium mb-2">Marks</label>
                            <input type="number" name="marks" id="marks" step="1" value="1" class="w-full  mx-auto rounded-md border-gray-300 bg-white px-3 py-2 shadow-sm placeholder-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        <div>
                            <label for="negative_marks" class="block text-sm font-medium mb-2">Negative Marks</label>
                            <select name="negative_marks" id="negative_marks" data-selected="{{ old('negative_marks', 0) }}" class="w-full  mx-auto rounded-md border-gray-300 bg-white px-3 py-2 shadow-sm placeholder-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
