                ...
                <form method="POST" action="{{ route('quizzes.questions.update', ['quiz' => $quiz->id, 'question' => $question->id]) }}">
                    ...
                    <div class="mb-4 grid grid-cols-3 gap-3">
                        <div>
                            ...
                            <input type="number" name="marks" id="marks" step="0.01" value="{{ old('marks', $quizQuestion->marks ?? 1) }}" class="w-full max-w-[98%] mx-auto rounded-md border-gray-300 bg-white px-3 py-2 shadow-sm placeholder-gray-400 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        <div>
