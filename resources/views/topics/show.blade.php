                        ...
                        <form method="POST" action="{{ route('topics.store') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="subtopic_name" name="name" required
                                    class="w-full  mx-auto rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            <div class="mb-4">
                                ...
                                <textarea id="subtopic_description" name="description" rows="2"
                                    class="w-full  mx-auto rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500"></textarea>
                            </div>
