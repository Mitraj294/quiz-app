...
class CreateQuizzesTable extends Migration
{
    ...
    public function up()
    {
        // Topics Table - SKIP: Already exists in our system
        if (!Schema::hasTable($this->tableNames['topics'])) {
        ...
        // Quiz, Questions and Topics Relations Table - SKIP: Already exists in our system
        if (!Schema::hasTable($this->tableNames['topicables'])) {
